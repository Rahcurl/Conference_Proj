...
function SessionPage() {
  ...
  // Debounced code sync - only sync after user stops typing for 500ms
  useEffect(() => {
      ...
      <div className="flex-1 overflow-hidden">
        <Group orientation="horizontal" className="h-full">
          ...
          <Panel defaultSize={10} minSize={10}>
            <div className="h-full bg-base-200 overflow-hidden flex flex-col p-2">
              {isInitializingCall ? (
                ...
                <div className="h-full flex items-center justify-center p-2">
                  <div className="card bg-base-100 shadow-lg w-full">
                    <div className="card-body items-center text-center p-4">
                      ...
                      <p className="text-xs text-base-content/70">Unable to connect to video call</p>
                    </div>
                  </div>
                </div>
              ) : (
